...
public class Targets extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        type = preferences.getString(GetData.KEY_TYPE_MONEY,"VND");
        //Log.e("typenow",type);
        initView();
...
//                Log.e("bill",bill.isChiTieu() +"");
    ...
    private void showDate(int date, int month, int year) {
        time.setText(new StringBuilder().append(date).append("/").append(month).append("/").append(year));
    }
    ...
    private void initView() {
        ...
        month = day.getMonth();
        year = day.getYear();
        typeMoney = (TextView) findViewById(R.id.tvtypeMOney);
        typeMoney.setText(type);
